<template>
    <section class="uc-contest-wrapper">
        <div class="uc-contest__container">
            <div v-for="item in filteredContest" :key="item.id" class="uc-contest">
                <div class="uc__item">
                    <p class="uc__decription h3">
                        {{ item.title }}
                    </p>
                    <div class="uc__directions">
                        <p v-for="(tag, index) in item.tags" :key="index" class="uc__direction p2">
                            {{ tag }}
                        </p>
                    </div>
                    <div class="uc__info">
                ...
                <div class="uc-contest__content">
                    <div class="uc-contest__decription">
                        ...
                        <div class="uc-contest__condition">
                            ...
                            <ul
                                v-for="(condition, index) in item.description.conditions"
                                :key="index"
                        ...
                        <div class="uc-contest__when-passes">
                            ...
                            <p
                                v-for="(date, index) in item.description.date"
                                :key="index"
                    ...
                    <div v-if="item.hasParticipant" class="uc-contest__application">
...
const filteredContest = computed(() => {
    const contestId = parseInt(route.params.id, 10)
    return props.contests.filter((item) => item.id === contestId)
})
