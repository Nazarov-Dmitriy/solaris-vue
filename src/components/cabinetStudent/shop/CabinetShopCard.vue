<template>
    <section class="shop-card-container">
        <div class="shop-card">
            <div class="card">
                <div class="card-adaptiv">
                    <h2 class="card-header-adptiv">Сертификат АНТИДВОЙКА</h2>
                    <div>
                ...
                <div>
                        <button type="button" class="cancel-btn-adaptiv">Отменить</button>
                </div>
            </div>
        </div>
    </section>
...
/* Что бы не появлялся скрок поменял 992 на 1100 */
...
/* Что бы не появлялся скрок поменял 768 на 950 */
...
/* Что бы не появлялся скрок поменял 390 на 480 */
@media (max-width: 480px) {
    .card-header-item > div {
        display: none;
    }
