<template>
    <section class="shop-card-container">
        <div class="shop-card">
            <div class="card">
                <div class="card-header">
                    <img class="card-img" src="/src/assets/image/cabinet/image.png" alt="Изображение отсутствует">
                    <h2 class="card-header-text h2">Сертификат АНТИДВОЙКА</h2>
                ...
                <div class="card-buttons">
                    ...
                    <div>
                        <button type="button" class="btn exchange-btn">Обменять</button>
                    </div>
                </div>
            </div>
        </div>
...
/* Что бы не появлялся скрол поменял 992 на 1100 */
...
/* Что бы не появлялся скрол поменял 768 на 950 */
...
/* Что бы не появлялся скрол поменял 576 на 650 */
...
/* Что бы не появлялся скрол поменял 390 на 480 */
