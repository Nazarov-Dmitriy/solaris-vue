                    ...
                    <ul class="cabinet-shop-ready__list">
                        ...
                        >
                            <div class="cabinet-shop-ready__list-item-img">
                                <img
                                    src="/src/assets/image/cabinet-shop/pic.png"
                                    alt="image"
                                >
                            </div>
...
.cabinet-shop-ready__title span {
  line-height: 150%;
  color: var(--white);
  background: var(--dark);
  position: relative;
...
.cabinet-shop__img-background img {
  width: 100%;
  height: 100%;
}


.shop-empty-history__popular {
  font-size: 20px;
  text-align: center;
  font-weight: 500;
  color: var(--orange)
...
.cabinet-shop__img-background--empty {
  position: absolute;
  top: 406px;
  right: 63px;
  display: flex;
...
.cabinet-shop__img-background--empty img {
  width: 100%;
  height: 100%;
}
